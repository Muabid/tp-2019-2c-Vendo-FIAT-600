...
int sac_write(int sock,const char* path,char* data, size_t size, off_t offset, pthread_rwlock_t rwlock);
int sac_unlink(int sock,const char* path);
int sac_readdir(int sock,const char* path, off_t offset);
int sac_read(int sock,const char* path, size_t size, off_t offset, pthread_rwlock_t rwlock);
