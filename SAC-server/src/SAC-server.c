...
int main(int argc, const char* argv[]) {
	...
	file_system = (t_block*) mmap(NULL, size_file_system +1 , PROT_WRITE | PROT_READ | PROT_EXEC,
	...
	bitmap =  bitarray_create_with_mode((char*)bitmap_content,size_file_system/BLOCK_SIZE/CHAR_BIT,LSB_FIRST);
